 ...
 * 
 * Ce fichier contient le formulaire liée à la réservation de salle
 * 
 */
...
if (!isset($_POST['choix']))
{
    ...
    <form action="selectiondate.php" method="post">
        <label class="digital" for="date">Date</label>
        ...
        <br>
        <label class="digital" for="heure">Heure</label>
        <select class="custom-select select-text" name="heure" id="heure" required="">
            <option selected value="09:00:00">09:00:00</option>
